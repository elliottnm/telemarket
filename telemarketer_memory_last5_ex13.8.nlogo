...
to sell
  ...
  set success-sell success-sell with [ let-call? myself ]
...
to account
  let cost ( size * 50 )
  let income ( sales * 2 )
  set balance ( balance + income - cost )
